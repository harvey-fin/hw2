...
{
    Product* ptr = new Book(prodName_, price_, qty_, isbn_, author_);
    return ptr;
}
...
{
    Product* ptr = new Clothing(prodName_, price_, qty_, size_, brand_);
    return ptr;
}
...
{
    Product* ptr = new Movie(prodName_, price_, qty_, genre_, rating_);
    return ptr;
}
